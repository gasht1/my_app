...
<div className="min-w-screen min-h-screen bg-gray-400 flex items-center justify-center px-5 pb-10 pt-16 py-48 w-3/4">
    <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700">
        ...
        <div className="mb-3">
            <label className="font-bold text-sm mb-2 ml-1">Name on account</label>
            <div>
                <input className="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="gashaw gebrie" type="text"/>
            </div>
        </div>
        <div className="mb-3">
            <label className="font-bold text-sm mb-2 ml-1">account number</label>
            <div>
