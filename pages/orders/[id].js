...
const order = () => {
    ...
    const statusClass =(index)=>{
        ...
        if(index-status>=1) return (
            <div className="opacity-0 undone ">
    ...
    <div className="container flex p-14">
      <div className="w-3/4 ">
        <ul className="flex gap-16 font-extrabold leading-4 text-center underline uppercase">
          <li>order id</li>
          <li className="px-12">customer</li>
          <li>address</li>
        ...
        <div className="flex py-6 gap-11">
          <div>
            <span className="font-bold text-red-600 ">12345673</span>
          </div>
          <div className="px-9">
        ...
        <div className="flex gap-16 mt-6 font-bold text-green-600 status ">
      ...
      <div className="w-1/4 left">
        <div className="w-[90%] h-[260px] bg-gray-700 text-white uppercase font-bold py-10 items-center justify-center px-8">
          ...
          <p className="py-4">
            subtotal :<span className="text-red-500">906</span>br
          </p>
          <p>
            discount :<span>0.0</span>br
          </p>
          <p>
            total :<span>906</span>br
          </p>
          <div className="py-6">
            <button
              disabled
              className="w-32 py-4 font-bold text-teal-400 uppercase bg-white rounded-lg"
            >
              paid
            </button>
          </div>
